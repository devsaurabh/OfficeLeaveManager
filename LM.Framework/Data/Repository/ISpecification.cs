namespace LM.Framework.Data.Repository
{
    ...
    {
        /// <summary>
        ///     Gets specification result wrapped into <see cref="ISpecificationResult{T}" /> interface.
        /// </summary>
        /// <remarks>
        ///     <see cref="ISpecificationResult{T}" /> interface wrapps common functionality that is shared
        ///     accross all specifications.
        /// </remarks>
        ISpecificationResult<T> ToResult();
    }
}