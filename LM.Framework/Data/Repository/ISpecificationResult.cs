...
namespace LM.Framework.Data.Repository
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    ///     If the specification model uses lazy loading using <see cref="IQueryable" />,
    ...
    ///     normally IQueryable supports should be implemented in <see cref="ISpecification{T}" />
    ...
    public interface ISpecificationResult<TEntity> where TEntity : class
    {
        ...
        /// </summary>
        /// <typeparam name="TKey">
        ///     The type of the key returned by the function that is
        ///     represented by keySelector.
        /// </typeparam>
        ...
        /// <summary>
        ///     Set no tracking to the query.
        /// </summary>
        /// <returns></returns>
        ISpecificationResult<TEntity> AsNoTracking();
        ...
        /// <summary>
        ///     Returns the Count of entites
        /// </summary>
        /// <returns></returns>
        int Count();

        IList<TResult> Select<TResult>(Expression<Func<TEntity, TResult>> keySelector);
